...
import { Motion, SceneElement } from '../../../platform/types';
import { SceneElementRenderer } from '../../../platform/scenes/SceneElement';
import { KOSlam } from '../scene-effects/KOSlam';
import { KOSlamParams } from '../scene-effects/ko-slam';
import { computeSlide, composeMotions, motionToTransform } from '../../../platform/motion';
